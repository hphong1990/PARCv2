...
class PARCv2(keras.Model):
    def __init__(self, n_state_var, n_time_step, step_size, image_size=(0, 0), int_rtol=1e-2, int_atol=1e-4, int_max_steps_per_step=1000, **kwargs):
        ...
        self.integrator = tfp.math.ode.DormandPrince(rtol=int_rtol, atol=int_atol, max_num_steps=n_time_step * int_max_steps_per_step)
